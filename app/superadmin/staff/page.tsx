    ...
    <div className="fixed inset-0 z-[200] flex items-center justify-center bg-black/40 backdrop-blur-sm p-4">
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-lg p-7 relative max-h-[90vh] overflow-y-auto">
        ...
        <form onSubmit={handleSubmit} className="space-y-3">
          ...
          {mode === "add" && (
            <div className="bg-purple-50 rounded-lg p-3 text-[11px] text-purple-700 flex items-start gap-2">
            ...
            {loading ? (
              ...
              <div className="divide-y divide-gray-50">
                {filtered.map((s, i) => {
                  ...
                  const createdFmt = new Date(s.user.createdAt).toLocaleDateString("lo-LA", { year: "numeric", month: "short", day: "2-digit" })
                  return (
                    <div key={s.id}
