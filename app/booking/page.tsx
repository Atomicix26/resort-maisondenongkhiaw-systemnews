...
export default function AdminDashboard() {
  ...
  // ✅ เริ่ม edit — copy ค่าปัจจุบันไว้
  ...
  const handleSave = (id: string) => {
    setRows(rows.map((r) =>
      r.id === id
        ? { ...r, title: editState.title, price: editState.price, status: editState.status }
        : r
    ));
    setEditingId(null);
  };
                ...
                return (
                  ...
                  >
                    ...
                    <div className="w-36">
                      {isEditing ? (
                        <select
                          ...
                          className="px-2 py-1.5 bg-white border border-blue-300 rounded-md text-[12px] outline-none focus:ring-2 focus:ring-blue-100 cursor-pointer font-medium"
                        >
                          {statusOptions.map((s) => (
                    ...
                    <div className="w-28 flex items-center gap-1">
                      {isEditing ? (
                        // ✅ ໃນ mode edit: ສະແດງປຸ່ມ Save + Cancel
                        <>
                          <button
                          ...
                          <button
                            ...
                            className="p-1.5 bg-gray-100 hover:bg-gray-200 text-gray-500 rounded-md transition-all"
                          >
                            <X size={13} />
                          </button>
                        </>
                      ) : (
                        // ✅ ໃນ mode ປົກກະຕິ: ສະແດງ ··· dropdown
                        <div className="relative">
                          <button
